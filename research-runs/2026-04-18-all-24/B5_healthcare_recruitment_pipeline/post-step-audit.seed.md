...
Confidence: 65% -> 47% - seeded from legacy synthesis only; quote-level verification and fresh contradiction search have not been executed in this run
...
- Partially verified legacy claims: 5
- Unverified legacy claims: 1
- Contradicted legacy claims: 1
- Legacy internal unresolved claims: 6
