...
Confidence: 65% -> 41% - seeded from legacy synthesis only; quote-level verification and fresh contradiction search have not been executed in this run
...
- Legacy zero-source external claims: 1
