...
Confidence: 65% -> 51% - seeded from legacy synthesis only; quote-level verification and fresh contradiction search have not been executed in this run
...
- Verified legacy claims: 3
- Partially verified legacy claims: 0
- Unverified legacy claims: 1
- Contradicted legacy claims: 0
