...
Confidence: 65% -> 46% - seeded from legacy synthesis only; quote-level verification and fresh contradiction search have not been executed in this run
...
- Verified legacy claims: 1
- Partially verified legacy claims: 1
- Unverified legacy claims: 0
- Contradicted legacy claims: 1
- Legacy internal unresolved claims: 4
- Legacy zero-source external claims: 0
- Dangling source refs: 1
