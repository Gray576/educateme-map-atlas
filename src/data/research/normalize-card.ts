...
export function normalizeResearchCard(
  ...
  return {
    ...
    estimatedCostToSignalEur: overlay.productMeta?.estimatedCostToSignalEur ?? null,
    estimatedDaysToSignal: overlay.productMeta?.estimatedDaysToSignal ?? null,
    ...
    founderIndependenceScore: overlay.productMeta?.founderIndependenceScore ?? null,
    regulatoryFrictionInverseScore: overlay.productMeta?.regulatoryFrictionInverseScore ?? null,
    retentionStructureScore: overlay.productMeta?.retentionStructureScore ?? null,
    demandEvidenceScore: overlay.productMeta?.demandEvidenceScore ?? null,
    willingnessToPayScore: overlay.productMeta?.willingnessToPayScore ?? null,
    cacRealityScore: overlay.productMeta?.cacRealityScore ?? null,
    macroTrajectoryScore: overlay.productMeta?.macroTrajectoryScore ?? null,
    channelFitScore: overlay.productMeta?.channelFitScore ?? null,
    validationVelocityComposite: overlay.productMeta?.validationVelocityComposite ?? null,
    demandPullComposite: overlay.productMeta?.demandPullComposite ?? null,
    validationConfidenceBand: overlay.productMeta?.validationConfidenceBand ?? "unknown",
